...
case "$1" in
    setup)
    cd $(dirname $SELF)
    deps/nerves_system_br/create-build.sh nerves_defconfig .nerves/artifacts/yeico_firmware_rpi3-portable-1.32.0
    cd .nerves/artifacts/yeico_firmware_rpi3-portable-1.32.0
